...
Public Class anggaran_pemasukan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pemberdayaan_Masyarakat.anggaran_pemasukan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedanggaran_pemasukan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As anggaran_pemasukan = New anggaran_pemasukan()
        rpt.Site = Me.Site
        Return rpt
    End Function
