...
Public Class agenda_range
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pemberdayaan_Masyarakat.agenda_range.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedagenda_range
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As agenda_range = New agenda_range()
        rpt.Site = Me.Site
        Return rpt
    End Function
