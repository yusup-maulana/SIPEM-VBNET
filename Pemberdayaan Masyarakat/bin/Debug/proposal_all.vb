...
Public Class proposal_all
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pemberdayaan_Masyarakat.proposal_all.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedproposal_all
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As proposal_all = New proposal_all()
        rpt.Site = Me.Site
        Return rpt
    End Function
