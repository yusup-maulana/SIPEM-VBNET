...
Public Class proposal_kelurahan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pemberdayaan_Masyarakat.proposal_kelurahan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_FILL() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedproposal_kelurahan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As proposal_kelurahan = New proposal_kelurahan()
        rpt.Site = Me.Site
        Return rpt
    End Function
