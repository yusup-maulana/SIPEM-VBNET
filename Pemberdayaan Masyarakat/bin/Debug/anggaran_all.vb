...
Public Class anggaran_all
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pemberdayaan_Masyarakat.anggaran_all.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedanggaran_all
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As anggaran_all = New anggaran_all()
        rpt.Site = Me.Site
        Return rpt
    End Function
